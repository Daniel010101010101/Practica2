...
namespace CapaVistas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<E_Alumno> lista = negocios.N_listaDeMaestros();
            ...
            while (opcion != 0)
            {
                ...
                switch (opcion)
                {
                    ...
                    case 4:
                        ...
                        break;
                    //Caso 5 Muestra lista de Maestros
                    case 5:
                        Console.WriteLine(" ************ LISTA DE MAESTROS ************");
                        foreach (E_Alumno item in lista)
                        {
                            Console.WriteLine("Nombre: " + item.Nombres + " " + item.Apellidos + 
                                "\nEdad: " + item.Edad);
                        }
                        Console.WriteLine("\n\n");
